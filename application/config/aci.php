...
$config['aci_module'] = array (
  ...
  array (
    'version' => '1',
    'charset' => 'utf-8',
    'lastUpdate' => '2018-05-18 11:52:29',
    'moduleName' => 'goods_list',
    'modulePath' => 'adminpanel',
    'moduleCaption' => '商品列表',
    'description' => '由autoCodeigniter 自动生成的模块',
    'fileList' => 
    array (
      0 => 'application/views/adminpanel/goods_list/edit.php',
      1 => 'scripts/adminpanel/goods_list/edit.js',
      2 => 'application/views/adminpanel/goods_list/readonly.php',
      3 => 'application/views/adminpanel/goods_list/lists.php',
      4 => 'scripts/adminpanel/goods_list/lists.js',
      5 => 'application/views/adminpanel/goods_list/choose.php',
      6 => 'application/controllers/adminpanel/Goods_list.php',
      7 => 'application/models/Goods_list_model.php',
    ),
    'works' => true,
    'moduleUrl' => 'adminpanel/goods_list',
    'system' => false,
    'coder' => '胡子锅',
    'website' => 'http://',
    'moduleDetails' => 
